-- ============================================================
-- 064: Fix create_employee_account — upsert user_profiles
-- ============================================================
-- El trigger on_auth_user_created (058) ya crea un user_profiles
-- al insertar en auth.users. La función create_employee_account
-- luego intenta INSERT y falla con duplicate key.
-- Fix: usar ON CONFLICT DO UPDATE para completar los campos.
-- ============================================================
