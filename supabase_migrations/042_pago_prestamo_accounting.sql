-- =====================================================
-- MIGRACIÓN 042: Contabilización de pagos de préstamos
-- 
-- Cuando un empleado paga/abona una cuota de préstamo
-- (fuera de nómina), se registra como ingreso en caja.
--
-- Contablemente:
--   Débito:  Caja/Banco (activo sube, entra dinero)
--   Crédito: 122 - Préstamos a Empleados (activo baja)
--
-- Es el asiento INVERSO al otorgamiento del préstamo.
-- =====================================================
...
BEGIN
    ...
    IF NEW.type = 'income' THEN
        ...
        ELSE
            -- INGRESO normal: Débito a Caja/Banco, Crédito a cuenta de ingreso
            CASE NEW.category
...
SELECT '✅ Trigger actualizado: pago_prestamo → Débito Caja, Crédito 122 Préstamos a Empleados' AS resultado;
