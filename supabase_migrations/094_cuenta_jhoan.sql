-- ============================================
-- MIGRACIÓN 094: Crear cuenta Jhoan
-- ============================================

-- 1. Crear cuenta en accounts
INSERT INTO accounts (name, type, balance, color, is_active, bank_name)
VALUES ('Jhoan', 'cash', 0, '#4CAF50', true, NULL)
ON CONFLICT DO NOTHING;

-- 2. Crear cuenta contable 105
INSERT INTO chart_of_accounts (code, name, type, level, is_active)
VALUES ('105', 'Caja Jhoan', 'asset', 3, true)
ON CONFLICT (code) DO NOTHING;

-- 3. Actualizar trigger contable para incluir Jhoan
