-- =====================================================
-- MIGRACIÓN 039: Restaurar funciones atómicas
-- =====================================================
-- Restaura las 3 funciones de la migración 032 que pudieron
-- haberse perdido por efectos CASCADE en la migración 038.
-- Usa CREATE OR REPLACE, 100% seguro de re-ejecutar.
-- =====================================================
...
-- =====================================================
-- 2. FUNCIÓN: Movimiento atómico con actualización de balance
-- =====================================================
