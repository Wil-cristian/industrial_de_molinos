...
void main() async {
  ...
  try {
    ...
    AppLogger.warning('No se pudo cargar .env, se continúa con variables por defecto.');
    AppLogger.warning('$e');
  }
  ...
  // Test de conexión en todos los modos (no solo debug)
...
class _MolinosAppState extends State<MolinosApp> {
  ...
  void _checkForUpdates() {
    // Esperar a que la app esté lista y el contexto disponible
    _updateCheckTimer?.cancel();
