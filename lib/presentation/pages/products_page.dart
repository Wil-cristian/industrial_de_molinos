...
class _ProductsPageState extends ConsumerState<ProductsPage> {
                  ...
                  Builder(
                    builder: (context) {
                      final cost = product.costPrice > 0
                          ...
                          : product.totalCost;
                      final margin = cost > 0
                          ? ((product.unitPrice - cost) / cost * 100)
                          : 0.0;
  ...
  void _showRecipeDetail(Product product) async {
    ...
    showDialog(
      context: context,
      builder: (context) {
        final compState = ref.read(componentsProvider);
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Expanded(
                                            flex: 4,
                                            child: Text(
                                              '${comp.calculatedWeight.toStringAsFixed(2)} kg',
                                              style: const TextStyle(
                                                fontSize: 11,
                                              ),
                                              textAlign: TextAlign.right,
                                          ...
                                          Expanded(
                                            flex: 4,
                                            child: Text(
                                              '\$${comp.totalCost.toStringAsFixed(2)}',
                                              style: const TextStyle(
                                                fontSize: 11,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Peso: ${compState.totalWeight.toStringAsFixed(2)} kg',
                                ),
  ...
  void _showRecipeDialog({Product? product}) async {
    ...
    if (isEditing) {
      ...
      tempComponents = existingComponents
          .map(
            (c) => _TempComponent(
                                ...
                                return Container(
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Column(
                                      ...
                                      children: [
                                        Text(
                                          '${material.stock.toStringAsFixed(1)} ${material.unit} disponible',
                                          style: TextStyle(
                                            fontSize: 10,
                                            color: Theme.of(
                                              context,
                                        ...
                                        Text(
                                          '\$ ${material.effectiveCostPrice.toStringAsFixed(2)} / ${material.unit}',
                                          style: TextStyle(
                                            fontSize: 10,
                                            color: AppColors.success,
                                            fontWeight: FontWeight.w500,
                                      ...
                                      onPressed: () {
                                        if (isCalculable) {
                                          ...
                                          setDialogState(() {
                                            ...
                                            if (material.unit == 'KG') {
                                              initialWeight = 1;
                                            } else if (material.fixedWeight !=
                                                null) {
                                              initialWeight =
                                                  material.fixedWeight!;
                                            }
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              'Componentes (${tempComponents.length})',
                              style: TextStyle(
                                fontWeight: FontWeight.w600,
                                color: Theme.of(context).colorScheme.onSurface,
                              ),
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    '\$${comp.unitCost.toStringAsFixed(2)} / ${comp.unit}',
                                                    style: TextStyle(
                                                      fontSize: 10,
                                                      color: Theme.of(context)
                                                          .colorScheme
                        ...
                        Builder(
                          builder: (context) {
                            final materialCost = tempComponents.fold(
                              0.0,
                            ...
                            final totalPrice =
                                materialCost + lossCost + laborCost;
            ...
            actions: [
              ...
              FilledButton(
                onPressed: () async {
                  ...
                  final totalWeight = tempComponents.fold(
                    0.0,
                    (sum, c) => sum + c.calculatedWeight,
                  );
                  ...
                  final newProduct = Product(
                    ...
                    costPrice:
                        materialCost +
                        lossCost, // Costo de materiales + pérdidas
                    stock: 0,
                    minStock: 0,
                    unit: 'UND',
                    isRecipe: true,
                    recipeDescription: descCtrl.text.isEmpty
                        ? null
                        : descCtrl.text,
  ...
  void _duplicateRecipe(Product product) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Receta duplicada')));
    }
  }
  ...
  void _showDimensionsDialog(
    ...
    String selectedType = category == 'tubo'
        ? 'cylinder'
        : category == 'lamina'
        ? 'rectangular_plate'
        : 'shaft';
    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) {
          ...
          double getDimensionMm(
            TextEditingController mmCtrl,
            TextEditingController inchCtrl,
            String fraction,
          ) {
            if (useInches) {
          ...
          void recalculate() {
            ...
            switch (selectedType) {
              case 'cylinder':
                final outerD = getDimensionMm(
                  outerDiameterCtrl,
                  outerDiameterInchCtrl,
                  outerDiameterFrac,
                );
                final thickness = getDimensionMm(
                  thicknessCtrl,
                  thicknessInchCtrl,
                  thicknessFrac,
                );
                final length = getDimensionMm(
                  lengthCtrl,
                  lengthInchCtrl,
                  lengthFrac,
                );
              ...
              case 'rectangular_plate':
                final width = getDimensionMm(
                  widthCtrl,
                  widthInchCtrl,
                  widthFrac,
                );
                final height = getDimensionMm(
                  heightCtrl,
                  heightInchCtrl,
                  heightFrac,
                );
          ...
          Widget buildInchInput(
            String label,
            TextEditingController inchCtrl,
            String currentFrac,
            Function(String) onFracChanged,
          ) {
            return Row(
              children: [
                // Pulgadas enteras
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: buildInchInput(
                              'Ø Ext',
                              outerDiameterInchCtrl,
                              outerDiameterFrac,
                              (v) =>
                                  setDialogState(() => outerDiameterFrac = v),
                            ),
                          ),
                        ],
                      ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: buildInchInput(
                              ...
                              thicknessInchCtrl,
                              thicknessFrac,
                              (v) => setDialogState(() => thicknessFrac = v),
                            ),
                          ),
                        ],
                      ),
                ...
                children: [
                  ...
                  SegmentedButton<String>(
                    ...
                    onSelectionChanged: (selection) {
                      setDialogState(() {
                        ...
                        widthCtrl.clear();
                        heightCtrl.clear();
                        outerDiameterInchCtrl.clear();
                        thicknessInchCtrl.clear();
                        lengthInchCtrl.clear();
                        widthInchCtrl.clear();
                        heightInchCtrl.clear();
                        outerDiameterFrac = '';
                        thicknessFrac = '';
                        lengthFrac = '';
                        widthFrac = '';
                  ...
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      Text(
                        'Costo: \$ ${material.effectiveCostPrice.toStringAsFixed(2)}/KG',
                        style: TextStyle(
                          color: Theme.of(context).colorScheme.onSurfaceVariant,
                          fontSize: 12,
                        ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                'Peso: ${calculatedWeight.toStringAsFixed(3)} KG',
                                style: const TextStyle(
                                  fontWeight: FontWeight.w500,
                                ),
                              ),
                      ...
                      FilledButton.icon(
                        onPressed: calculatedWeight > 0
                            ? () {
                                ...
                                final thick = getDimensionMm(
                                  thicknessCtrl,
                                  thicknessInchCtrl,
                                  thicknessFrac,
                                );
                                final len = getDimensionMm(
                                  lengthCtrl,
                                  lengthInchCtrl,
                                  lengthFrac,
                                );
                                final wid = getDimensionMm(
                                  widthCtrl,
                                  widthInchCtrl,
                                  widthFrac,
                                );
                                final hei = getDimensionMm(
                                  heightCtrl,
                                  heightInchCtrl,
                                  heightFrac,
                                );
                                ...
                                String dimDesc = '';
                                String cat = selectedType == 'cylinder'
                                    ? 'tubo'
                                    : selectedType == 'rectangular_plate'
                                    ? 'lamina'
                                    : 'eje';
                                ...
                                if (useInches) {
                                  ...
                                  if (selectedType == 'cylinder') {
                                    dimDesc =
                                        'Ø${fmtInch(outerDiameterInchCtrl, outerDiameterFrac)}×${fmtInch(thicknessInchCtrl, thicknessFrac)}×${fmtInch(lengthInchCtrl, lengthFrac)}';
                                  } else if (selectedType ==
                                      'rectangular_plate') {
                                    dimDesc =
                                        '${fmtInch(widthInchCtrl, widthFrac)}×${fmtInch(heightInchCtrl, heightFrac)}×${fmtInch(thicknessInchCtrl, thicknessFrac)}';
                                  } else {
                                    dimDesc =
                                        'Ø${fmtInch(outerDiameterInchCtrl, outerDiameterFrac)}×${fmtInch(lengthInchCtrl, lengthFrac)}';
                                  }
                                } else {
                                  // Formato en mm
                                  if (selectedType == 'cylinder') {
                                    dimDesc =
                                        'Ø${outerDiameterCtrl.text}×${thicknessCtrl.text}×${lengthCtrl.text}mm';
                                  } else if (selectedType ==
                                      'rectangular_plate') {
                                    dimDesc =
                                        '${widthCtrl.text}×${heightCtrl.text}×${thicknessCtrl.text}mm';
                                  } else {
                                    dimDesc =
                                        'Ø${outerDiameterCtrl.text}×${lengthCtrl.text}mm';
                                  }
                                }
  ...
  IconData _getShapeIcon(String category) {
    ...
    switch (category) {
      case 'tubo':
        return Icons.circle_outlined; // Tubo hueco (cilindro)
      case 'lamina':
        return Icons.crop_square; // Lámina (rectángulo)
      case 'eje':
        return Icons.horizontal_rule; // Eje sólido (barra)
      default:
