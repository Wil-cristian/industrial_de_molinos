...
import 'messenger_funds_dialog.dart';
...
String _categoryLabel(MovementCategory category, [String? customName]) {
  switch (category) {
    ...
    case MovementCategory.fondo_mensajero:
      return 'Fondo Mensajero';
    case MovementCategory.devolucion_fondo:
      return 'Devolución Fondo';
...
class _DailyCashPageState extends ConsumerState<DailyCashPage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      ref.read(employeesProvider.notifier).loadEmployees(activeOnly: true);
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      if (isMobile) ...[
                                        ...
                                        IconButton(
                                          onPressed: () =>
                                              _showMessengerFundsDialog(context),
                                          icon: const Icon(Icons.local_shipping),
                                          tooltip: 'Fondos Mensajeros',
                                          style: IconButton.styleFrom(
                                            backgroundColor: const Color(
                                              0xFF8E24AA,
                                            ).withOpacity(0.1),
                                    ...
                                    Wrap(
                                      ...
                                      children: [
                                        ...
                                        ElevatedButton.icon(
                                          ...
                                          label: const Text('Fondos Mensajeros'),
                                          style: ElevatedButton.styleFrom(
                                            backgroundColor: const Color(
                                              0xFF8E24AA,
                                            ),
  ...
  void _showMessengerFundsDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => const MessengerFundsDialog(),
    );
  }
              ...
              children: [
                ...
                Builder(
                  builder: (context) {
                    ...
                    // Mostrar clientes y proveedores (gastos pueden ser a clientes, proveedores u otros)
                      ...
                      fieldViewBuilder:
                          (context, controller, focusNode, onFieldSubmitted) {
                            ...
                            return TextFormField(
                              ...
                              focusNode: focusNode,
                              decoration: InputDecoration(
                                labelText: 'Proveedor/Cliente (opcional)',
  ...
  void _save() async {
    ...
    try {
      ...
      if (movementId != null) {
        ...
        final errorMsg = ref.read(dailyCashProvider).error ??
