...
class AppBottomNavBar extends ConsumerWidget {
  ...
  static const _moreCategories = [
    ...
    _MoreCategory(
      ...
      items: [
        ...
        _BottomNavItem(
          iconFilled: Icons.schedule_send,
          iconOutlined: Icons.schedule_send_outlined,
          label: 'Anticipadas',
          route: '/advance-sales',
          branchIndex: 19,
          screenKey: AppScreen.advanceSales,
        ),
      ],
    ),
    _MoreCategory(
  ...
  void _onItemTapped(
    ...
    if (index == 4) {
      _showMoreSheet(context, permissions, badges: badges);
      return;
    }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final chatBadge = ref.watch(chatPendingCountProvider).value ?? 0;
    final badges = <String, int>{
      if (chatBadge > 0) AppScreen.chat: chatBadge,
    };
              ...
              for (int i = 0; i < _mainItems.length; i++)
                Expanded(
                  child: _NavBarItem(
                    ...
                    onTap: () => _onItemTapped(context, i, permissions, badges: badges),
                  ),
                ),
              Expanded(
                child: _NavBarItem(
                  ...
                  onTap: () => _onItemTapped(context, 4, permissions, badges: badges),
                ),
              ),
            ],
          ),
                ...
                final catItems = cat.items.map((item) {
                  ...
                  return _StaggeredMoreItem(
                    ...
                    child: _MoreMenuItem(
                      ...
                      badgeCount: widget.badges[item.screenKey] ?? 0,
