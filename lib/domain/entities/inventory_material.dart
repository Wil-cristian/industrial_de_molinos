...
enum MaterialShape {
  ...
  solidCylinder, // Cilindro sólido / Eje redondo
  solidSquare, // Barra cuadrada / Eje cuadrado
...
enum MeasurementUnit { milimetros, pulgadas }
...
class InventoryMaterial {
  ...
  final InventoryMaterialType
  type; // Tipo de material (tubo, lamina, tapa, eje, porKilo, porUnidad)
  ...
  double calculateWeight({
    ...
    switch (shape) {
      case MaterialShape.cylinder:
        ...
        final volume =
            pi * (outerRadius * outerRadius - innerRadius * innerRadius) * l;
      ...
      case MaterialShape.solidSquare:
        // Barra cuadrada: lado² × L × densidad
        final lado = w > 0 ? w : d1;
        final volume = lado * lado * l;
        weight = volume * density;
        break;
      ...
      case MaterialShape.ring:
        ...
        final volume =
            pi * (outerRadius * outerRadius - innerRadius * innerRadius) * t;
        weight = volume * density;
        break;
