...
class BusinessHealthMonthly {
  ...
  factory BusinessHealthMonthly.fromJson(Map<String, dynamic> json) {
    ...
    return BusinessHealthMonthly(
      month: parsedMonth,
      year: (json['year'] as num?)?.toInt() ?? parsedMonth.year,
      monthNum: (json['month_num'] as num?)?.toInt() ?? parsedMonth.month,
      creditExtended: (json['credit_extended'] as num?)?.toDouble() ?? 0,
      revenue: (json['revenue'] as num?)?.toDouble() ?? 0,
      collected: (json['collected'] as num?)?.toDouble() ?? 0,
      estimatedProfit: (json['estimated_profit'] as num?)?.toDouble() ??
          (json['net_profit_estimate'] as num?)?.toDouble() ?? 0,
      ...
      collectionRatio: (json['collection_ratio'] as num?)?.toDouble() ??
          (json['collection_rate'] as num?)?.toDouble() ?? 0,
