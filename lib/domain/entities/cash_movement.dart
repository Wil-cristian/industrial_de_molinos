...
MovementCategory parseCategoryFromJson(String value) {
  ...
  switch (value) {
    case 'transfer_out':
      return MovementCategory.transferOut;
    case 'transfer_in':
      return MovementCategory.transferIn;
    case 'purchase':
    ...
    case 'adelanto_sueldo':
      return MovementCategory.nomina;
    case 'fondo_mensajero':
      return MovementCategory.fondo_mensajero;
    case 'devolucion_fondo':
      return MovementCategory.devolucion_fondo;
    case 'otherExpense':
      return MovementCategory.gastos_reducibles;
    default:
...
enum MovementCategory {
  ...
  fondo_mensajero, // Entrega de fondo a mensajero (no es gasto real)
  devolucion_fondo, // Devolución de fondo de mensajero
  // Traslados
